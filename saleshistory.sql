--Count the customers who are all ordered from the USA
...
SELECT COUNT(DISTINCT CUSTOMERNAME) AS Customercount FROM SALES WHERE PRICEEACH*QUANTITYORDERED > 5000;
...
--Find the total sale price for each year:
